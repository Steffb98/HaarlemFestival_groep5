...
<nav>
    <li>
        <div id="Dashboard" class="NavItem"><a href="../View/DashboardView.php">Dashboard</a></div>
    </li>
    <li>
        <div id="Message" class="NavItem"><a href="../View/MessageView.php">Messages</a></div>
    </li>
    <li>
        <div id="Update" class="NavItem"><a href="../View/UpdateView.php">Updates</a></div>
    </li>
    <li>
        <div id="Activity" class="NavItem"><a href="../View/ActivityView.php">Activities</a></div>
    </li>
    <?php if ($loggedInUser->Function >= 2) { ?>
        <li>
            <div id="User" id="LastNavItem" class="NavItem"><a href="../View/CMSUserView.php">Users</a></div>
        </li><?php } ?>
    <?php if ($loggedInUser->Function == 3) { ?>
        <a id="Barrier" class="AddEdit">Add/Edit</a>
        <li>
            <div id="Information" class="NavItem"><a class="AddEdit" href="../View/InformationView.php">Information
                    -</a></div>
        </li>
        <li>
            <div id="Restaurant" class="NavItem"><a class="AddEdit" href="../View/CMSRestaurantView.php">Restaurants
                    -</a></div>
        </li>
        <li>
            <div id="Schedule" class="NavItem"><a class="AddEdit" href="../View/ScheduleView.php">Schedules -</a></div>
        </li>
        <li>
            <div id="UpdateAE" class="NavItem"><a class="AddEdit" href="../View/UpdateAEView.php">Updates -</a></div>
        </li>
        <li>
            <div id="ActivityAE" class="NavItem"><a class="AddEdit" href="../View/ActivityAEView.php">Activities -</a>
            </div>
        </li>
        <li>
            <div id="Volunteer" class="NavItem"><a class="AddEdit" href="../View/VolunteerView.php">Volunteers -</a>
            </div>
        </li>
        <li>
            <div id="Revenue" class="NavItem"><a class="AddEdit" href="../View/RevenueView.php">Revenue -</a></div>
        </li>
    <?php } ?>
</nav>
<div class="TopBar">
